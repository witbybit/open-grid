...
| 011 | [Feature Boundary Architecture](./011-feature-boundary-architecture.md)           | TODO   | 53fe61f |
...
- Plan 011 is the next architecture step: it targets the remaining cross-file patch pattern by moving feature mutations behind explicit feature controllers and a mutation/effects contract.
