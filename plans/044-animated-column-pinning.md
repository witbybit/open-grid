...
```sh
corepack pnpm --filter @open-grid/core exec vitest run src/renderer/layoutTransitionController.test.ts src/renderer/renderPaintCoordinator.test.ts src/renderer/renderEngine.test.ts
