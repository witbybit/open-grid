...
const COLUMNS: ColumnDef<KanbanCard>[] = [
	{
		...
		width: 440,
		minWidth: 260,
		renderer: { kind: 'react', component: TitleCell, capabilities: { scrollSnapshot: 'html' } },
	},
	{
		field: 'status',
		header: 'Status',
		width: 130,
		renderer: { kind: 'react', component: StatusCell, capabilities: { scrollSnapshot: 'html' } },
	},
	{
		field: 'assignee',
		header: 'Owner',
		width: 70,
		renderer: { kind: 'react', component: AssigneeCell, capabilities: { scrollSnapshot: 'html' } },
	},
	{
		field: 'progress',
		header: '%',
		width: 70,
		renderer: { kind: 'react', component: ProgressCell, capabilities: { scrollSnapshot: 'html' } },
	},
	{
		field: 'storyPoints',
		header: 'Pts',
		width: 60,
		renderer: { kind: 'react', component: PointsCell, capabilities: { scrollSnapshot: 'html' } },
	},
	{
		field: 'dueDate',
		header: 'Due',
		width: 100,
		renderer: { kind: 'react', component: DueDateCell, capabilities: { scrollSnapshot: 'html' } },
	},
	{
		field: 'epic',
		header: 'Epic',
		width: 160,
		renderer: { kind: 'react', component: EpicCell, capabilities: { scrollSnapshot: 'html' } },
	},
];
