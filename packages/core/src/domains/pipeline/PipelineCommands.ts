...
export function registerPipelineCommands<TRow>(kernel: GridKernel, pipeline: RowPipeline<TRow>): () => void {
	...
	offs.push(
		kernel.register('pipeline.setSortModel', (command) => {
	...
	offs.push(
		kernel.register('pipeline.setFilterModel', (command) => {
	...
	offs.push(
		kernel.register('pipeline.setQuery', (command) => {
	...
	offs.push(
		kernel.register('pipeline.setGroupBy', (command) => {
	...
	offs.push(
		kernel.register('pipeline.toggleGroup', (command) => {
	...
	offs.push(
		kernel.register('pipeline.setGroupExpanded', (command) => {
	...
	offs.push(
		kernel.register('pipeline.expandAllGroups', () => {
	...
	offs.push(
		kernel.register('pipeline.collapseAllGroups', () => {
	...
	offs.push(
		kernel.register('pipeline.setTreeData', (command) => {
	...
	offs.push(
		kernel.register('pipeline.toggleTreeNode', (command) => {
	...
	offs.push(
		kernel.register('pipeline.toggleDetail', (command) => {
	...
	offs.push(
		kernel.register('pipeline.setDetailOpen', (command) => {
