...
export function createApiFacade<TRowData>(
	...
	const api = {
		...
		subscribeDomain: (domain: Parameters<typeof store.subscribeDomain>[0], listener: Parameters<typeof store.subscribeDomain>[1]) => store.subscribeDomain(domain, listener),
