...
export function createGridRuntimeComposition<TRowData>({
	...
	const api = {
		...
		validateCell: (rowId: string, colField: string) => runtime.validateCell(rowId, colField),
		validateGrid: () => runtime.validateGrid(),
		setCellValidationError: (rowId: string, colField: string, error: string) => runtime.setCellValidationError(rowId, colField, error),
		clearCellValidationError: (rowId: string, colField: string) => runtime.clearCellValidationError(rowId, colField),
		clearValidationErrors: () => runtime.clearValidationErrors(),
		getCellValidationError: (rowId: string, colField: string) => runtime.getCellValidationError(rowId, colField),
		hasValidationErrors: () => runtime.hasValidationErrors(),
		getAllValidationErrors: () => runtime.getAllValidationErrors(),
		...
		runDataQualityCheck: (options?: { scope?: import('../features/dataQuality/dataQualityTypes.js').DataQualityReport['scope'] }) =>
			runtime.runDataQualityCheck(options),
		getDataQualityReport: () => runtime.getDataQualityReport(),
		clearDataQualityReport: () => runtime.clearDataQualityReport(),
		registerDataQualityRule: (rule: import('../features/dataQuality/dataQualityTypes.js').DataQualityRule<TRowData>) =>
			runtime.registerDataQualityRule(rule),
		...
		resolveConflict: (id: string, opts: import('../features/conflict/conflictTypes.js').ResolveConflictOptions) =>
			runtime.resolveConflict(id, opts),
		clearConflict: (id: string) => runtime.clearConflict(id),
		clearAllConflicts: () => runtime.clearAllConflicts(),
		createTransactionStream: (opts?: import('../features/liveStream/liveStreamTypes.js').TransactionStreamOptions) =>
			runtime.createTransactionStream(opts),
		destroy,
	};
